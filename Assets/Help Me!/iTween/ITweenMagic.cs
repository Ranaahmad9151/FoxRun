...
public class ITweenMagic : MonoBehaviour
{
	...
	public void PlayUIMovement()
	{
		...
		iTween.ValueTo(this.gameObject, iTween.Hash("ignoretimescale", true, "delay", delayMovement, "from", GetComponent<RectTransform>().anchoredPosition, "to", targetPosition2D,
	...
	public void PlayWorldMovement()
	{
		...
		iTween.ValueTo(this.gameObject, iTween.Hash("ignoretimescale", true, "delay", delayMovement, "from", GetComponent<Transform>().localPosition, "to", targetPosition3D,
    ...
    public void PlayReverseUIMovement()
    {
		...
		iTween.ValueTo(this.gameObject, iTween.Hash("ignoretimescale", true, "delay", delayMovement, "from", GetComponent<RectTransform>().anchoredPosition, "to", initialPosition2D,
			"time", timeMovement, "looptype", LoopTypeMovement.ToString(), "onupdate", "MoveGuiElement","oncomplete", "OnMovementTweenCompleted", "easetype", EaseTypeMovement.ToString()));
    }
	...
	public void PlayForwardWorldMovement()
    {
			GetComponent<Transform>().localPosition = initialPosition3D;				
		iTween.ValueTo(this.gameObject, iTween.Hash("ignoretimescale", true, "delay", delayMovement, "from", GetComponent<Transform>().localPosition, "to", targetPosition3D,
			"time", timeMovement, "looptype", LoopTypeMovement.ToString(), "ignoretimescale", true, "oncomplete", "OnMovementTweenCompleted", "onupdate", "MoveObject","easetype", EaseTypeMovement.ToString()));
    }
    ...
    public void PlayForwardScale()
    {
        GetComponent<Transform>().localScale = initialScale;
		iTween.ValueTo(this.gameObject, iTween.Hash("delay", delayScale, "from", GetComponent<Transform>().localScale, "to", targetScale, "time", timeScale,
			"looptype", LoopType.none, "onupdate", "ScaleObject", "ignoretimescale", true, "oncomplete", "OnScaleTweenCompleted", "easetype", EaseTypeScale.ToString()));
    }

    public void PlayReverseScale()
    {
        GetComponent<Transform>().localScale = targetScale;
		iTween.ValueTo(this.gameObject, iTween.Hash("ignoretimescale", true, "delay", delayScale, "from", GetComponent<Transform>().localScale, "to", initialScale, "time", timeScale,
    ...
    {
        GetComponent<Transform>().localEulerAngles = initialRotation;
		iTween.ValueTo(this.gameObject, iTween.Hash("ignoretimescale", true, "delay", delayRotation, "from", GetComponent<Transform>().localEulerAngles, "to", targetRotation, 
			"time", timeRotation, "looptype", LoopTypeRotation.ToString(), "ignoretimescale", true, "ignoretimescale", true,  "onupdate", "RotateObject","oncomplete", "OnRotationTweenCompleted", "easetype", EaseTypeRotation.ToString()));
    ...
    public void PlayReverseRotation()
    {
		...
		iTween.ValueTo(this.gameObject, iTween.Hash("ignoretimescale", true, "delay", delayRotation, "from", GetComponent<Transform>().localEulerAngles, "to", initialRotation,
			"time", timeRotation, "looptype", LoopTypeRotation.ToString(), "ignoretimescale", true, "onupdate", "RotateObject","oncomplete", "OnRotationTweenCompleted", "easetype", EaseTypeRotation.ToString()));
