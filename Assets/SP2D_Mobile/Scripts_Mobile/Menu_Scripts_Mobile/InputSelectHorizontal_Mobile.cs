...
public class InputSelectHorizontal_Mobile : MonoBehaviour {
	...
	void Update () {
		...
		if (Input.GetAxisRaw ("Horizontal") != 0 && buttonSelected == false) { // If we move by the menu in horizontal direction with the keys of the keyboard or the joystick of our gamepad and the button which i want to select is not selected...
