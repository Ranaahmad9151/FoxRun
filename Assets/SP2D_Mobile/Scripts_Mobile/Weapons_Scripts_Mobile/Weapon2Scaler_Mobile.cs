...
namespace Bitboys.SuperPlaftormer2D {
	...
	public class Weapon2Scaler_Mobile : MonoBehaviour {
		...
		private Weapon2_Mobile weapon2; // the reference to the weapon script.
		...
		void Update () {
			...
			if (weapon2.gotWeapon2 && weapon2.wp2Selected && !player.touchingLeftWall && !player.touchingRightWall) {
