...
namespace Bitboys.SuperPlaftormer2D {
	...
	public class Weapon2Item_Mobile : MonoBehaviour {
	...
	void OnTriggerEnter2D (Collider2D other)
	{
		// When the player collides with the item activates some options.
			...
			return;
		weapon2.gotWeapon2 = true;// we got this weapon activated and ready to be used.
		weapon2.wp2Selected = true;// this will make that when we pick up the item automatically we will have the weapon one selected.
		weapon2.weapon2AmmoAmount = 50;// This is the amount of ammo that the weapon will have when the item is picked up
