...
namespace Bitboys.SuperPlaftormer2D {
	...
	public class Weapon3Item_Mobile : MonoBehaviour {
	...
	void OnTriggerEnter2D (Collider2D other)
	{
		// When the player collides with the item activates some options.
			...
			return;
		weapon3.gotWeapon3 = true;// we got this weapon activated and ready to be used.
		weapon3.wp3Selected = true;// this will make that when we pick up the item automatically we will have the weapon one selected.
		weapon3.weapon3AmmoAmount = 25;// This is the amount of ammo that the weapon will have when the item is picked up
