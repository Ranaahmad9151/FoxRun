...
namespace Bitboys.SuperPlaftormer2D {
	...
	public class Weapon1Scaler_Mobile : MonoBehaviour {
	...
	private Weapon1_Mobile weapon1; // the reference to the weapon script.
	...
	void Update () {
		...
		if (weapon1.gotWeapon1 && weapon1.wp1Selected && !player.touchingLeftWall && !player.touchingRightWall) {
